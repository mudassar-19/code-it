...
export default function IconCard({
  ...
  return (
    <motion.div
      ...
      className="group relative overflow-hidden rounded-2xl border border-light-teal/60 bg-card p-6 shadow-soft transition-shadow duration-300 hover:border-bright-cyan hover:shadow-glow"
    >
